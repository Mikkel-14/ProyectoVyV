...
Característica: Registrar avances del progreso
  ...
  Como colaborador de un proyecto tengo que actualizar diariamente la información del progreso de mis tareas
  para que el sistema pueda marcar las tareas críticas

  Escenario: # TODO terminar
    Dado que existen dos tareas dependientes
    Cuando un colaborador acceda al diagrama de Gantt
    Entonces se podrá observar el porcentaje del progreso de las tareas